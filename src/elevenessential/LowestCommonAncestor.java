...
public class LowestCommonAncestor {
	...
	public static void main(String[] args) {
		//atleast o(n) as it is not sorted, sopace O(logn)
		//assumptions - no duplicates, atmost 2 children, binary tree, no level attribute, no back link 
		//find path from head or mentioned node to the clind nodes, then find hte common path, last node in the common path
		// will be he lowest common ancestor
